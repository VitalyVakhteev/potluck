		...
		<div className="rounded-2xl border p-4 hover:shadow-sm transition">
			<div className="flex items-center justify-between mb-2">
				...
				{fundraiser.active ? (
					...
					<span
						className="text-xs px-2 py-0.5 rounded-full bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
						Inactive
					</span>
				)}
			</div>

			<h4 className="text-md text-muted-foreground line-clamp-1 mb-3">By: {fundraiser.organizerUsername}</h4>
