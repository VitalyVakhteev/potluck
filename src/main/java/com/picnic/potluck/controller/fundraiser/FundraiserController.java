...
public class FundraiserController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Fundraiser created successfully"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Fundraiser edited successfully"),
            @ApiResponse(responseCode = "400", description = "Illegal argument (endsAt before startsAt)"),
            @ApiResponse(responseCode = "401", description = "Unauthorized request"),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Fundraiser deleted successfully"),
            @ApiResponse(responseCode = "401", description = "Unauthorized request"),
            @ApiResponse(responseCode = "403", description = "Forbidden request, not the OP"),
            @ApiResponse(responseCode = "404", description = "The specified fundraiser was not found")
    })
